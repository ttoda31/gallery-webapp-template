<template>
  <v-container class="fill-height">
    <v-responsive class="d-flex align-center text-center fill-height">
      ...
      <div class="text-body-2 font-weight-light mt-3">Message from Backend: {{ backendMsg }}</div>
...
const backendMsg = ref("No message...");

api.get("/").then((response) => { backendMsg.value = response.data; });
</script>
